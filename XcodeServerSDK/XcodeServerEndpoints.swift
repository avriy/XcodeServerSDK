...
open class XcodeServerEndpoints {
    ...
    */
    func createRequest(_ method: HTTP.Method, endpoint: Endpoint, params: [String : String]? = nil, query: [String : String]? = nil, body: JSON? = nil, doBasicAuth auth: Bool = true, portOverride: Int? = nil) -> URLRequest? {
        var allParams = [
