...
open class BotConfiguration : XcodeServerEntity {
    ...
    */
    ...
    public required init(json: [String: Any]) throws {
        ...
        self.triggers = try json.xcodeReadValues("triggers")
        self.sourceControlBlueprint = try json.xcodeReadValue(for: "sourceControlBlueprint")
    ...
    open override func dictionarify() -> JSON {
        ...
        for (key, value) in botScheduleDict {
